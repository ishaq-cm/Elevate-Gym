...
export default function Footer() {
  return (
    <footer className="bg-card border-t-2 border-border pt-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16">
        {/* Col 1 */}
        <div>
          <div className="flex items-center gap-2 mb-6">
            <span className="font-headline text-3xl tracking-[0.15em] text-white">ELEVATE</span>
            <span className="font-headline text-3xl tracking-[0.15em] text-primary">GYM</span>
          </div>
          <p className="font-body text-sm text-muted italic mb-6">Forge Your Best Self</p>
          <address className="not-italic text-xs text-muted leading-relaxed mb-4">
        ...
        {/* Col 4 */}
        <div>
          <h4 className="font-headline text-lg tracking-[0.3em] text-white mb-8">Join The Movement</h4>
          <p className="text-xs text-muted leading-relaxed mb-6">Get fitness tips, class updates and exclusive member offers.</p>
          <div className="flex">
            <input 
              type="email" 
      ...
      <div className="max-w-7xl mx-auto border-t border-border py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-[11px] text-muted tracking-widest uppercase order-2 md:order-1">
          © 2025 ELEVATE GYM. ALL RIGHTS RESERVED.
        </div>
        <div className="font-headline text-primary text-xl order-1 md:order-2">
          FORGE YOUR BEST SELF
        </div>
        <div className="text-[11px] text-muted flex gap-4 order-3">
